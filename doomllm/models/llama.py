# Adapted from https://github.com/vllm-project/vllm/tree/b2c3fc5d65485bfed796ee11c2a019d70357ad10/vllm/model_executor/models/llama.py
import logging
...
from doomllm.distributed import get_tensor_model_parallel_rank, get_tensor_model_parallel_world_size
from doomllm.layers.activation import SiluAndMul
from doomllm.layers.layernorm import LlamaRMSNorm
from doomllm.layers.linear import MergedColumnParallelLinear, QKVParallelLinear, RowParallelLinear
from doomllm.layers.pooler import Pooler, PoolingType
from doomllm.layers.quantization.base_config import QuantizationConfig
